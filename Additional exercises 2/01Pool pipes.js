function poolPipes(input){
    ...
    if (V >= P1NP2Total) {
        console.log (`The pool is ${PercentageOfP1P2}% full. Pipe 1: ${PercentageOfP1.toFixed(2)}%. Pipe 2: ${PercentageOfP2.toFixed(2)}%.`)
    } else {
        console.log(`For ${N} hours the pool overflows with ${difference.toFixed(2)} liters.`)
    }
}
